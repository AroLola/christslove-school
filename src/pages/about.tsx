...
{ name: 'ESTER MALAKIA', role: 'Teacher, Grade 1, Yellow', imageUrl: "/assets/media/estermalakiajpg" },
...
{ name: 'LYANE ZVEKARE', role: 'Teacher, Grade 5, Blue & Vice Sports Organizer, Deputy', imageUrl: "/assets/media/lyane.jpg" },
