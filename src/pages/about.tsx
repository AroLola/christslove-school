...
{ name: 'NAUYOMA HILENI', role: 'Department Head, Early Childhood Development & Teacher, Kindergarten, 4-5 Years', imageUrl: "/assets/media/patience.jpg" },
{ name: 'SAUMA NDYULUWA', role: 'Department Head, Pre-Primary', imageUrl: "/assets/media/sauma.jpg" },
...
{ name: 'ESTER MALAKIA', role: 'Teacher, Grade 1, Yellow', imageUrl: "/assets/media/drmemoir.jpg/assets/media/estermalakiajpg" },
...
{ name: 'LYANE ZVEKARE', role: 'Teacher, Grade 5, Blue & Vice Sports Organizer, Deputy', imageUrl: "lyane.jpg" },
...
{ name: 'MAGRIETA BASSON', role: 'Teacher, Afrikaans, Grade 4-5', imageUrl: "/assets/media/magrieta.jpg" },
...
{ name: 'GENEFEFA GOTFRIED', role: 'Custodian', imageUrl: "/assets/media/genefefa.jpg" },
{ name: 'JEQUILINE LIVIMBA', role: 'Tuck Shop, Custodian', imageUrl: "/assets/media/jequiline.jpg" },
{ name: 'MARIA AUKHUMES', role: 'Cashier', imageUrl: "/assets/media/maria.jpg" },
{ name: 'MARTHA NHEKAIRO', role: 'Teacher, Grade 3, Green', imageUrl: "/assets/media/martha.jpg" },
...
{ name: 'BRASH NDARA', role: 'Teacher, Grade 6, Red', imageUrl: "/assets/clcslogo.jpg" },
{ name: 'ESTER NAKUMBWATA', role: 'Custodian', imageUrl: "/assets/clcslogo.jpg" },
{ name: 'PRISCA KOROMORA', role: 'Department Head, Junior Primary & Teacher, Grade 2, Green', imageUrl: "/assets/clcslogo.jpg" },
