                  ...
                  return (
                    <div key={event.id}>
                      ...
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="font-heading text-xl md:text-2xl font-bold text-secondary">{event.name}</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {event.media.map((video, i) => (
                            ...
                            >
                              ...
                              {video.caption && <p className="px-3 py-2 text-sm text-foreground/70">{video.caption}</p>}
                              <button
                                onClick={() => handleRemoveMedia(event.id, video.id)}
