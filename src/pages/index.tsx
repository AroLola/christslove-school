...
<div className="relative w-[480px] mx-auto z-0"> 
  ...
  > 
    <video 
      ...
      className="absolute top-0 left-0 w-full h-[680px] object-cover object-top transition-transform duration-360 ease-out group-hover:-translate-y-[100px]" 
      controls 
      loop 
      autoPlay 
      muted 
  ...
  <div className="absolute -bottom-0.3 -right-1 w-full h-full border-2 border-primary rounded-lg -z-1 pointer-events-none" /> 
</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0"> 
              ...
              <div className="hidden lg:flex items-center justify-center p-16 bg-white/5 backdrop-blur-sm border-l border-primary"> 
                <div className="text-center"> 
                  <div className="font-heading text-8xl text-primary/50 font-bold leading-none mb-2">K–7</div> 
                  <p className="text-white/40 text-sm tracking-widest uppercase">Kindergarten through Grade 7</p> 
