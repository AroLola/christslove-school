...
>
  ...
  {/* MASTER SLOT 3: Holds Images 9, 10, 11, 12 */}
  <motion.div variants={fadeUp} className="flex flex-col gap-4 w-full">
    {[
      ...
      <section className="relative flex items-center overflow-hidden" style={{ minHeight: '88vh' }}>
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-24">
          <motion.div
            ...
            <motion.p
              variants={fadeUp}
              className="text-primary font-medium tracking-widest uppercase text-sm mb-4" style={{ color: "#ffffff" }}>
...
<section className="py-20 bg-secondary">
  <div className="container mx-auto px-4 lg:px-8">
    ...
    >
      ...
      <motion.h2 variants={fadeUp} className="font-heading text-4xl md:text-5xl text-secondary-foreground">
        AWARDS
      </motion.h2>
    </motion.div>
